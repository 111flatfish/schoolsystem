        ...
        <main>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane" v-bind:id="'content'+(index2+1)" v-for="(item,index2) in majorRight">
                                        <div class="list-group">
                                            ...
                                            <div class="list-group-item" v-for="subitem in majorRightContent[0]">
                                                <!--图片-->
            ...
            <div class="slide">
                <ul class="row clearfix">
                    <li class="media" v-for="item in majorMid">
                            ...
                            <div class="media-body">
                                <h3 class="media-heading">{{item.major_name}}</h3>
                                <p>{{item.indroduce}}</p>
                            </div>
                        </li>
                </ul>
            ...
            // 左边内容显示区请求的数据
              axiosReq.get("getMajor/id/1").then(data=>{
                  ...
                  $(function () {
                      // 初始化
                      let m = 0;
                      $(".show1 .content .list-group-item").eq(0).siblings().hide();
